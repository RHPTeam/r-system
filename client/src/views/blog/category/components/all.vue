<template>
  <div class="blog--category feature" :data-theme="currentTheme">
    <div class="blog--category-title pt_3 pb_3">ALL</div>
    <!-- Horizontal item -->
    <div v-if="!blogs"></div>
    <div v-else v-for="blog in blogs" :key="blog._id" class="item--category item--horizontal mb_4">
      <div class="ct_f p_0">
        <div class="r">
          <div class="c_md_4 pl_md_3 pr_md_2">
          ...
          <div class="c_md_8 pl_md_2 pr_md_3">
