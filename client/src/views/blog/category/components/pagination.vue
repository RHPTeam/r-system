<template>
    <div class="content--paginate text_center text_md_right">
        <nav aria-label="Page navigation example">
            <ul class="pagination justify_content_center justify_content_md_end pt_3">
