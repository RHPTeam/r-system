              ...
              <div class="r">
                ...
                <div class="c_md_12">
                  <div class="card card_body p_0 mt_n1 mt_sm_0 mt_md_3">
                    <router-link tag="h5" :to="{name: 'post', params: {blogId: lastBlog[0]._id}}" class="card_title mb_2 mt_2 mt_sm_0">
                      {{lastBlog[0].title}}
                    </router-link>
              ...
              <div class="r">
                ...
                <div class="c_md_8 pl_md_3 pr_md_3">
                  <div class="card card_body p_0 mt_n1 mt_sm_0">
                    <router-link tag="h5" :to="{name: 'post', params: {blogId: blog._id}}" class="card_title mb_2 mt_2 mt_md_0">
                      {{blog.title}}
                    </router-link>
