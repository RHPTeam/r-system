  ...
  <div class="note--question">
    <div class="note--italic">
      <p class="t_normal">
        ...
        <a href="#">cookie policy</a>, and that your continued use of the
    ...
    <div class="note--final">
      <p>
        ...
        <a
          href="#"
          class="note--final-item t_name"
        >python</a>
        <a href="#" class="note--final-item t_name">javascript</a>
        or
